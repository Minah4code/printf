...
/**
 * print_hexa - Prints an unsigned decimal number in hexadecimal format
 *
 * @types: The argument list passed to the function
 * @map_to: The mapping characters for hexadecimal conversion
		...
		char flag_ch, int width, int precision, int size)
{
	...
	return (write_unsgnd(num, buffer, flags, width, precision, size));
}

/**
 * print_unsigned - Prints an unsigned integer number.
 * @args: A va_list containing the unsigned integer number to be printed.
 *
 * Return: The number of characters printed.
 */
...
/**
 * print_unsigned_number - Recursive helper function to print an unsigned number.
...
/**
 * print_hex_number - Recursive helper function to print a hexadecimal number.
 * @n: The number to be printed.
 * @base: The base digits for the hexadecimal number (e.g., "0123456789abcdef").
 *
 * Return: The number of characters printed.
 */
